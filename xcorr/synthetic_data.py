# Taking the two sequences after filtering smoothing as an example, the cross-correlation is explained.
...
timeshift = 30
t1 = to+timeshift
series1 = signal.unit_impulse(length, idx=to)  # Dirac impulse
series2 = signal.unit_impulse(length, idx=t1)

# Low-pass filtering smooth boundary (beautify the image)
b, a = signal.butter(4, 0.1)  # Filter
...
print(shift)
plt.savefig('Signal_cc.png', dpi=300, bbox_inches='tight')
plt.show()
