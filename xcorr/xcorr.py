# The time domain cross-correlation of two or more sequences is calculated.
...
data_203 = obspy.read(path + '/220320.080510.EB000203.EHZ.sac')[0].data    # Set 203 as a fixed station
...
plt.savefig('Station_cc.png', dpi=300, bbox_inches='tight')
plt.show()
